...
function calc() {
   ...
   function initLocalSettings(selector, activeClass) {
      ...
      elements.forEach(el => {
         ...
         if (el.getAttribute('data-ratio') === localStorage.getItem('ratio')) el.classList.add(activeClass)
      })
   }
   ...
   function calcTotal() {
      ...
      if (sex === 'female') result.textContent = Math.round((447.6 + (9.2 * weight) + (3.1 * height) - (4.3 * age)) * ratio);
