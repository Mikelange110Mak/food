window.addEventListener('DOMContentLoaded', () => {
   ...
   //72 Creating Modal window 
   //    &
   //73 Модификация модального окна
   ...
   */
   ...
   function getStaticInformatiom(parentSelector, activeClass) {
   ...
   getStaticInformatiom('#gender', 'calculating__choose-item_active');
   getStaticInformatiom('.calculating__choose_big', 'calculating__choose-item_active');
